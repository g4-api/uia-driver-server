...
namespace Uia.DriverServer.Extensions
{
    public static class AutomationExtensions
    {
        ...
        public static ushort GetKeyCode(this string key)
        {
            ...
            return CodeMaps.EnUnitedStatesCodeMap.TryGetValue(key, out ushort keyCode) ? keyCode : ushort.MaxValue;
        }
        ...
        /// <summary>
        /// Retrieves the scan code for the specified key using the default "en-US" keyboard layout.
        /// </summary>
        ...
        {
            // Delegate to the overload that accepts a keyboard layout, using "en-US" as the default.
            return GetScanCode(key, layout: "en-US");
        }

        /// <summary>
        /// Retrieves the scan code for the specified key using the provided keyboard layout.
        /// </summary>
        /// <param name="key">The key for which to retrieve the scan code.</param>
        /// <param name="layout">The keyboard layout identifier (e.g., "en-US", "he-IL").</param>
        /// <returns>The scan code associated with the key if found; otherwise, <see cref="ushort.MaxValue"/>.</returns>
        public static ushort GetScanCode(this string key, string layout)
        {
            ...
            // Return the found scan code; if not found, return ushort.MaxValue as an error indicator.
        ...
        public static void SendModifiedKey(this CUIAutomation8 _, string modifier, string key)
        {
            ...
            static ushort GetKeyCode(string key)
            {
                ...
                return CodeMaps.EnUnitedStatesCodeMap.TryGetValue(key, out ushort keyCode) ? keyCode : (ushort)0x00;
            }
        ...
        private static IUIAutomationElement GetApplicationRootElement(UiaSessionResponseModel session)
        {
            ...
            static IUIAutomationElement GetFromFileExplorer(UiaSessionResponseModel session)
            {
                ...
                while (DateTime.Now < timeout)
                {
                    ...
                    if (rootElement != null)
                    {
                        session.Runtime = [.. rootElement.GetRuntimeId().Cast<int>()];
                        return rootElement;
                    }
