...
namespace Uia.DriverServer.Extensions
{
    ...
    public static class CodeMaps
    {
        ...
        public static Dictionary<string, ushort> EnUnitedStatesCodeMap => new(
            collection:NonAlphabeticCodeMap,
        ...
        public static Dictionary<string, ushort> HeStandardCodeMap => new(
            collection: NonAlphabeticCodeMap,
            comparer: StringComparer.OrdinalIgnoreCase)
        {
            ["Esc"] = 0x01,
